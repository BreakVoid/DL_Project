...
\section*{Introduction * need to be edited}
...
\\
After preprocessing the data, another major work need to be decided is the model of neural networks.\\
All of the information of these part is shown in the {\it $3^{rd}$ Section} {\bf Model of Neural Networks}
